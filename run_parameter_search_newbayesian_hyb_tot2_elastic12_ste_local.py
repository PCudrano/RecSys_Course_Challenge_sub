    ...
    try:
       ...
       ##########################################################################################################
        ...
        if recommender_class is HybridLinCombEstRatings:
            ...
            hyperparamethers_range_dictionary["alphas1"] = Real(low=25.0, high=35.0)
            hyperparamethers_range_dictionary["alphas2"] = Real(low=60.0, high=80.0)
            ...
            hyperparamethers_range_dictionary["alphas6"] = Real(low=90.0, high=110.0)
            hyperparamethers_range_dictionary["alphas7"] = Real(low=0.0, high=10.0)
            hyperparamethers_range_dictionary["alphas8"] = Real(low=35.0, high=50.0)
            hyperparamethers_range_dictionary["alphas9"] = Real(low=35.0, high=50.0)
            hyperparamethers_range_dictionary["alphas10"] = Real(low=0.0, high=5.0)
            hyperparamethers_range_dictionary["alphas11"] = Real(low=130.0, high=150.0)
            hyperparamethers_range_dictionary["alphas12"] = Real(low=110.0, high=130.0)
            hyperparamethers_range_dictionary["alphas13"] = Real(low=135.0, high=150.0)

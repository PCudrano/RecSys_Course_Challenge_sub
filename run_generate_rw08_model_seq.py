...
if __name__ == '__main__':
    ...
    try:
        ...
        if recommender_class is SLIM_BPR_Cython:
            ...
            recommender.saveModel("result_experiments/hyb_est_ratings_6/", file_name="SLIM_BPR_rw_300_seq")
        ...
        if recommender_class is ImplicitALSRecommender:
            ...
            recommender.saveEstRatings("result_experiments/hyb_est_ratings_6/", file_name="ALS_rw_est_rat_seq", user_id_array=userList_unique, k=160)

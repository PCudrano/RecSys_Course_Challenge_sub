...
def read_data_split_and_search(parallel=False):
    ...
    evaluator_validation_earlystopping = SequentialEvaluator(URM_validation, cutoff_list=[10], minRatingsPerUser=1, exclude_seen=True)
    evaluator_test = SequentialEvaluator(URM_test, cutoff_list=[10], minRatingsPerUser=1, exclude_seen=True)

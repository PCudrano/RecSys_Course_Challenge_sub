...
if __name__ == '__main__':
    ...
    try:
        ...
        with open("../../../dump/dump_est_rat_seq_array_train0802th2", "wb") as dump_file:
            pickle.dump(recsys_est_ratings, dump_file)
        ...
        with open("../../../dump/dump_est_rat_seq_sum_train0802th2", "wb") as dump_file:
            pickle.dump(recommender.mine_est_ratings, dump_file)
